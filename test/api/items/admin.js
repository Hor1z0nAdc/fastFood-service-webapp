...
//     //createDeliveryMan
//     it('futár létrehozása, vissza kell adnia futár objektumot - createDeliveryMan()', async () => {
//         let futár = await delivery.createDeliveryMan(name, email, password1)
...
//         let name, email, correctPw1, incorrectPw1, pw2
...
//         it('helyes adatok, redirectelnie kell mentés után', (done) => {
//             chai.request(server) 
//                 .get("/futarok")
//                 .send({name: name, email: email, password1: correctPw1, password2: pw2})
//                 .end((err, res) => {
//                     expect(res).to.have.status(200);
//                     Felhasználó.findOneAndDelete({ email: email }, (err, res) => {})
//                 }) 
//                 done()
//         });
//     });
...
//     let req, név, leírás, error, correctár, NanÁr, negativeÁr
...
//     //Útvonalak
//     describe('itemActionController útvonalak', () => {
//         it('GET /change-item/:id', (done) => {
//             chai.request(server) 
//             .get("/change-item/1")
//             .end((err, res) => {
//                 expect(res).to.have.status(200);
